...
class TestFileStorage(unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.rev1 = Review()
        cls.rev1.place_id = "Praise"
        cls.rev1.user_id = "obah"
    ...
    def test_all(self):
        ...
        self.assertIs(instances_dic, storage.__FileStorage__objects)

    def test_new(self):
        """
        Tests method: new (saves new objects into dictionary)
        """
        ...
        obah.name = "Obah"
        m_storage.new(obah)
        key = obah.__class__.__name__ + "." + str(melissa.id)
